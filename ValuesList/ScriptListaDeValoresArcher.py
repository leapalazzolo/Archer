...
def main():
    ...
    parser.add_option('-i', '--input', dest='input', help='Ingrese la carpeta donde se encuentran los archivos archerschema.xsd obtenidos antes de realizar la migracion.', action='store_true')
    parser.add_option('-o', '--output', dest='output', help='Ingrese la carpeta donde se encuentran los archivo archerschema.xsd obtenidos luego de realizar la migracion.', action='store_true')
                ...
                with open(nombre_primer_archivo_parseado,'w+') as primer_archivo_xsd_datos:
                    ...
                    with open(nombre_segundo_archivo_parseado, 'w+') as segundo_archivo_xsd_datos:                    
                        ...
                        with open('Comparacion_ListasdeValores.csv','w+') as archivo_comparacion:
                            ...
                            comparar_archivos(primer_archivo_xsd_datos, nombre_segundo_archivo_parseado, archivo_comparacion)
